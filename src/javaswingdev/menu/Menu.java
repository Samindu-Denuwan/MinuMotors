...
public class Menu extends JPanel {
    ...
    private void init() {
        ...
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.RECEIPT, "Purchase Orders", "Issue PO", "View PO"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.RECEIPT,  "GRN", "Issue GRN", "View GRN"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.RECEIPT,  "Goods Return", "Issue Notes", "View Notes"));
        ...
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.RECEIPT, "Service Invoice"));
          addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.INFO, "Service Info"));
        addTitle("PRODUCT");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.CHECK, "Manage Products"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.DIRECTIONS_BIKE, "Brand"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.SEARCH, "Category"));
        ...
        addTitle("SUPPLIERS");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PERSON, "Manage Suppliers"));
        addTitle("EMPLOYEES");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PERSON_PIN, "Manage Employees"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PERSON_OUTLINE, "Manage Users"));
        
         addTitle("SALARY");
         addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.MONETIZATION_ON, "Manage Basic Salary"));
         addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.RECEIPT, "Generate Paysheet"));
