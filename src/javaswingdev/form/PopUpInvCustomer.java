...
public class PopUpInvCustomer extends javax.swing.JFrame {

    private Logger log;
    private Invoice invoiceP;

    public PopUpInvCustomer() {
        initComponents();
        setLocationRelativeTo(null);

        initLogger();
        log = Logger.getLogger("bikeLogger");
        log.info("Select Customer Inv Popup Page Loaded");
        table.fixTable(jScrollPane1);
        loadTable();

    }

    PopUpInvCustomer(Invoice invoice) {
        this();
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Customer ID", "Customer Name", "Mobile No"
            }
        ) {
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        try {
            ...
            invoiceP.txt_customer_id.setText(cus_id);
            invoiceP.txt_customer_name.setText(name);
            invoiceP.txt_customer_mobile.setText(mobile);
            dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopUpInvCustomer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopUpInvCustomer().setVisible(true);
            }
        });
    }
    ...
    private void loadTable() {
        try {
            ...
            DefaultTableModel dtm = (DefaultTableModel) table.getModel();
            dtm.setRowCount(0);
            ResultSet rs = DB.search("SELECT * FROM customer where stat = 1");
            while (rs.next()) {
                Vector v = new Vector();
