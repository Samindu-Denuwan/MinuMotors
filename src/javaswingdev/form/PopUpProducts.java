...
public class PopUpProducts extends javax.swing.JFrame {
    ...
    PopUpProducts (PurchaseOrder po){
        this();
        this.po = po;
    }
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
            ...
            po.txt_product_id.setText(pro_id);
            po.txt_product_name.setText(name);
             ResultSet rs = DB.search("select * from brand where brand_id ='" + brandId + "' ");
            if (rs.next()) {
             String brand = rs.getString("brand_name");
             po.txt_product_brand.setText(brand);
             dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopUpProducts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopUpProducts().setVisible(true);
            }
        });
    }
