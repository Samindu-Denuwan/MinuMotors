...
public class PopUpSuppliers1 extends javax.swing.JFrame {

     private Logger log;
     private GoodsReceiveNote grn;
    
    public PopUpSuppliers1() {
        initComponents();
        setLocationRelativeTo(null);
        
        initLogger();
        log = Logger.getLogger("bikeLogger");
        log.info("Select Suppliers Popup Page1 Loaded");
        table.fixTable(jScrollPane1);
        loadTable();
        
    }
    
    PopUpSuppliers1 (GoodsReceiveNote grn){
        this();
        this.grn = grn;
    }
    ...
    private void initComponents() {
        ...
        jLabel13.setText("SELECT SUPPLIERS");
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Supplier ID", "Name", "Mobile No", "Email"
            }
        ) {
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
            ...
            String mobile = dtm.getValueAt(selectRow, 2).toString();
            String email = dtm.getValueAt(selectRow, 3).toString();
          
            grn.txt_supplier_id.setText(sup_id);
            grn.txt_supplier_name.setText(name);
            grn.txt_supplier_mobile.setText(mobile);
            grn.txt_supplier_email.setText(email);
            dispose();
           
        } catch (Exception e) {
            log.error("Load Suppliers Details Failed", e);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopUpSuppliers1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopUpSuppliers1().setVisible(true);
            }
        });
    }
    ...
    private void loadTable() {
            ...
            DefaultTableModel dtm = (DefaultTableModel) table.getModel();
            dtm.setRowCount(0);
            ResultSet rs = DB.search("select * from supplier where stat = '1'");
            while (rs.next()) {
                Vector v = new Vector();
