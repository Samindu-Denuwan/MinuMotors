...
public class PopUpInvItems extends javax.swing.JFrame {

     private Logger log;
     private ViewInvoice invoice;
    
    public PopUpInvItems() {
        initComponents();
        setLocationRelativeTo(null);
        
         initLogger();
        log = Logger.getLogger("bikeLogger");
        log.info("View Inv Items Popup Page Loaded");
        table.fixTable(jScrollPane1);
        loadTable();
        
    }
    
    PopUpInvItems (ViewInvoice invoice){
        this();
    ...
    private void initComponents() {
        ...
        jLabel13.setText("INVOICE PRODUCTS");
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Invoice ID", "Stock ID", "Product ID", "Unit Price", "Qty", "Subtotal"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopUpInvItems.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopUpInvItems().setVisible(true);
            }
        });
    }
    ...
    private void loadTable() {
            ...
            DefaultTableModel dtm = (DefaultTableModel) table.getModel();
            dtm.setRowCount(0);
            ResultSet rs = DB.search("select * from invoice_item where invoice_id='"+SystemConfigData.getAllinvID()+"'");
            while (rs.next()) {
                Vector v = new Vector();
