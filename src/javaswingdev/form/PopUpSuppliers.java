...
public class PopUpSuppliers extends javax.swing.JFrame {

     private Logger log;
     private PurchaseOrder po;
    
    public PopUpSuppliers() {
        initComponents();
        setLocationRelativeTo(null);
        
         initLogger();
        log = Logger.getLogger("bikeLogger");
        log.info("Select Suppliers Popup Page Loaded");
        table.fixTable(jScrollPane1);
        loadTable();
        
    }
    
    PopUpSuppliers (PurchaseOrder po){
        this();
        this.po = po;
    }
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
            ...
            po.txt_supplier_id.setText(sup_id);
            po.txt_supplier_name.setText(name);
            po.txt_supplier_mobile.setText(mobile);
            po.txt_supplier_email.setText(email);
            dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopUpSuppliers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopUpSuppliers().setVisible(true);
            }
        });
    }
