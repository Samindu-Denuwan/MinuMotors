...
public class PopUpLowQty extends javax.swing.JFrame {
    ...
    public PopUpLowQty() {
        ...
        log.info("Select Low Qty Popup Page Loaded");
        table.fixTable(jScrollPane1);
        loadTable();
        
    }
    
    PopUpLowQty (CheckStock1 checkStock1){
        this();
        this.checkStock1 = checkStock1;
    }
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Stock ID", "Product ID", "Product Name", "Quantity"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopUpLowQty.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopUpLowQty().setVisible(true);
            }
        });
    }
    ...
    private void loadTable() {
          try {
            ...
            DefaultTableModel dtm = (DefaultTableModel) table.getModel();
            dtm.setRowCount(0);
            ResultSet rs = DB.search("select s.stock_id, s.product_id,p.product_name,"
                    + "s.quantity from stock as s, product as p where s.status = 1 && "
                    + "s.quantity <= 10 && s.product_id = p.product_id");
            while (rs.next()) {
                Vector v = new Vector();
            ...
            log.error("Low Qty Table Failed", e);
        }
    }
}
