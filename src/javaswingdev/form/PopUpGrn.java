...
public class PopUpGrn extends javax.swing.JFrame {
    ...
    public PopUpGrn() {
        ...
        log.info("Select GRN Popup Page Loaded");
        table.fixTable(jScrollPane1);
        loadTable();
        
    }
    
    PopUpGrn (GoodsReceiveNote grn){
        this();
        this.grn = grn;
    }
    ...
    private void initComponents() {
        ...
        jLabel13.setText("PREVIOUS GRNS");
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "GRN ID", "Supplier ID", "Date", "PO ID", "Total", "Isssued Employee"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopUpGrn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
