...
public class PopUpMechanics extends javax.swing.JFrame {

     private Logger log;
     private ServiceInvoice invoice1;
    
    public PopUpMechanics() {
        initComponents();
        setLocationRelativeTo(null);
        
        initLogger();
        log = Logger.getLogger("bikeLogger");
        log.info("Select Mechanics Popup Page1 Loaded");
        table.fixTable(jScrollPane1);
        loadTable();
        
    }
    
    PopUpMechanics (ServiceInvoice invoice){
        this();
    ...
    private void initComponents() {
        ...
        jLabel13.setText("SELECT MECHANICS");
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
            ...
            invoice1.txt_mechanic.setText(emp_id);
            dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopUpMechanics.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopUpMechanics().setVisible(true);
            }
        });
    }
    ...
    private void loadTable() {
            ...
            DefaultTableModel dtm = (DefaultTableModel) table.getModel();
            dtm.setRowCount(0);
            ResultSet rs = DB.search("select * from employee where stat = '1' and role_id = 'ROL-31427'");
            while (rs.next()) {
                Vector v = new Vector();
            ...
            log.error("Load Mechanics Details Failed", e);
        }
    }
}
