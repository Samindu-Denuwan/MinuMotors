...
public class PopUpGrnItems extends javax.swing.JFrame {

     private Logger log;
     private ViewGRN gRN;
    
    public PopUpGrnItems() {
        initComponents();
        setLocationRelativeTo(null);
        
         initLogger();
        log = Logger.getLogger("bikeLogger");
        log.info("View GRN Items Popup Page Loaded");
        table.fixTable(jScrollPane1);
        loadTable();
        
    }
    
    PopUpGrnItems (ViewGRN gRN){
        this();
        this.gRN = gRN;
    }
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "GRN ID", "Product ID", "Qty", "Buying Price", "Selling Price", "Subtotal"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopUpGrnItems.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopUpGrnItems().setVisible(true);
            }
        });
    }
    ...
    private void loadTable() {
            ...
            DefaultTableModel dtm = (DefaultTableModel) table.getModel();
            dtm.setRowCount(0);
            ResultSet rs = DB.search("select * from grn_item where grn_id='"+SystemConfigData.getAllGrnID()+"'");
            while (rs.next()) {
                Vector v = new Vector();
