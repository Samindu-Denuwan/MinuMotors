...
public class BikeCustomer extends javax.swing.JFrame {

     private Logger log;
     private BikeRegister bikeRegister;
    ...
    public BikeCustomer() {
        ...
        log.info("Select Bike Customers Page Loaded");
        table.fixTable(jScrollPane1);
        loadTable();
        
    }
    
    BikeCustomer (BikeRegister bikeRegister){
        this();
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Bike ID", "Brand ID", "Model", "Customer ID"
            }
        ) {
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
            ...
            bikeRegister.txt_customer_ID.setText(cus_id);
            bikeRegister.txt_customer_name.setText(name);
            bikeRegister.txt_mobileno.setText(mobile);
            dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BikeCustomer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BikeCustomer().setVisible(true);
            }
        });
    }
    ...
    private void loadTable() {
            ...
            DefaultTableModel dtm = (DefaultTableModel) table.getModel();
            dtm.setRowCount(0);
            ResultSet rs = DB.search("select * from customer ORDER by customer_id DESC");
            while (rs.next()) {
                Vector v = new Vector();
