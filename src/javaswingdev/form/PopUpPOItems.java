...
public class PopUpPOItems extends javax.swing.JFrame {
    ...
    public PopUpPOItems() {
        ...
        log.info("View PO Items Popup Page Loaded");
        table.fixTable(jScrollPane1);
        loadTable();
        
    }
    
    PopUpPOItems (ViewPO pO){
        this();
        this.pO = pO;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopUpPOItems.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopUpPOItems().setVisible(true);
            }
        });
    }
    ...
    private void loadTable() {
            ...
            DefaultTableModel dtm = (DefaultTableModel) table.getModel();
            dtm.setRowCount(0);
            ResultSet rs = DB.search("select * from purchase_order_item where purchase_order_id='"+SystemConfigData.getAllPOID()+"'");
            while (rs.next()) {
                Vector v = new Vector();
