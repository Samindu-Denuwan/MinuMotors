...
public class PopUpEmp extends javax.swing.JFrame {
    ...
    public PopUpEmp() {
        ...
        log.info("Select Emp Popup Page1 Loaded");
        table.fixTable(jScrollPane1);
        loadTable();

    }

    PopUpEmp(BasiCSalary basiCSalary) {
        this();
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        try {
            ...
            String role = dtm.getValueAt(selectRow, 2).toString();

            basiCSalary.txt_emp_id.setText(emp_id);
            basiCSalary.txt_emp_name.setText(emp_name);
            basiCSalary.txt_role.setText(role);
            dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopUpEmp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void loadTable() {
        try {
            ...
            DefaultTableModel dtm = (DefaultTableModel) table.getModel();
            dtm.setRowCount(0);
            ResultSet rs = DB.search("select e.emp_id, e.fname, "
                    + "e.lname, e.role_id, r.role from employee as e,"
                    + " role as r where e.role_id = r.role_id && e.stat = 1 "
                    + "&& e.role_id != 'ROL-31424'");
            while (rs.next()) {
                Vector v = new Vector();
